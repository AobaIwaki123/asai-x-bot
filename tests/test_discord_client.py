...
class TestDiscordClient:
    ...
    def test_discord_post_with_content(self):
        ...
        responses.add(responses.POST, "https://discord.com/webhook", status=200)

        with patch("src.discord_client.WEBHOOK_URL", "https://discord.com/webhook"):
            discord_post(content="Test message")

        assert len(responses.calls) == 1
        assert json.loads(responses.calls[0].request.body) == {"content": "Test message"}
    ...
    def test_discord_post_with_embed(self):
        ...
        assert len(responses.calls) == 1
        assert json.loads(responses.calls[0].request.body) == {"embeds": [embed]}
    ...
    def test_discord_post_with_both(self):
        ...
        expected_payload = {"content": "Test message", "embeds": [embed]}
    ...
    def test_discord_post_http_error(self):
        ...
        responses.add(responses.POST, "https://discord.com/webhook", status=400)
    ...
    def test_discord_post_connection_error(self):
        ...
        responses.add(responses.POST, "https://discord.com/webhook", body=ConnectionError("Connection failed"))
    ...
    def test_to_embed_basic_tweet(self):
        ...
        users_idx = {
            "user1": {"username": "testuser", "name": "Test User", "profile_image_url": "https://example.com/avatar.jpg"}
        }
        ...
        expected = {
            ...
            "author": {"name": "Test User", "url": "https://x.com/testuser", "icon_url": "https://example.com/avatar.jpg"},
    ...
    def test_to_embed_with_image(self):
        ...
        tweet = {
            ...
            "public_metrics": {"like_count": 20, "retweet_count": 8},
            "attachments": {"media_keys": ["media1", "media2"]},
        }

        users_idx = {"user1": {"username": "testuser", "name": "Test User"}}

        media_idx = {
            "media1": {"type": "photo", "url": "https://example.com/image1.jpg"},
            "media2": {"type": "video", "preview_image_url": "https://example.com/video_thumb.jpg"},
        }
